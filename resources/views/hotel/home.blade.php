...
<!-- /nav_panel -->
    ...
    <div class="hero home-search full-height jarallax" data-jarallax-video="mp4:{{ asset('hotel_assets/video/sunset.mp4') }},webm:{{ asset('hotel_assets/video/sunset.webm') }},ogv:{{ asset('hotel_assets/video/sunset.ogv') }}" data-speed="0.2">
            ...
            <div class="row justify-content-between flex-lg-row-reverse align-items-center">
                <div class="col-lg-5">
                    <div class="parallax_wrapper">
                        <img src="{{ asset('hotel_assets/img/home_2.jpg" alt="" class="img-fluid rounded-img') }}" >
                        <div data-cue="slideInUp" class="img_over"><span data-jarallax-element="-30"><img src="{{ asset('hotel_assets/img/home_1.jpg') }}"  alt="" class="rounded-img"></span></div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="intro">
        ...
        <div class="pinned-image pinned-image--medium">
            <div class="pinned-image__container" id="section_video">
                <video loop="loop" muted="muted" id="video_home">
                    <source src="{{ asset('hotel_assets/video/swimming_pool_2.mp4') }}"  type="video/mp4">
                    <source src="{{ asset('hotel_assets/video/swimming_pool_2.webm') }}"  type="video/webm">
                    <source src="{{ asset('hotel_assets/video/swimming_pool_2.ogv') }}"  type="video/ogg">
                </video>
        ...
        <div class="container margin_120_95">
                ...
                <div class="col-lg-6">
                    <div class="pinned-image rounded_container pinned-image--small mb-4">
                        <div class="pinned-image__container">
                            <img src="{{ asset('hotel_assets/img/local_amenities_1.jpg') }}"  alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
            ...
            <div class="row justify-content-between d-flex align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="pinned-image rounded_container pinned-image--small mb-4">
                        <div class="pinned-image__container">
                            <img src="{{ asset('hotel_assets/img/local_amenities_3.jpg') }}"  alt="">
                        </div>
                    </div>
                </div>
    ...
    <div class="parallax_section_1 jarallax" data-jarallax data-speed="0.2">
        <img class="jarallax-img kenburns-2" src="{{ asset('hotel_assets/img/hero_home_1.jpg') }}"  alt="">
                        ...
                        <div class="carousel_testimonials owl-carousel owl-theme nav-dots-orizontal">
                            <div>
                                <div class="box_overlay">
                                    <div class="pic">
                                        <figure><img src="{{ asset('hotel_assets/img/testimonial_1.jpg') }}"  alt="" class="img-circle">
                                        </figure>
            ...
            <div class="row justify-content-center home">
                <div class="item col-xl-4 col-lg-6">
                    <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="300">
                        <figure><img src="{{ asset('hotel_assets/img/blog-1.jpg') }}"  alt="" class="img-fluid"><em>11 Dec</em></figure>
                        <div class="wrapper">
                ...
                <div class="item col-xl-4 col-lg-6">
                    <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="400">
                        <figure><img src="{{ asset('hotel_assets/img/blog-3.jpg') }}"  alt="" class="img-fluid"><em>24 Dec</em></figure>
                        <div class="wrapper">
                ...
                <div class="item col-xl-4 col-lg-6">
                    <a href="news-post.html" class="box_contents" data-cue="slideInUp" data-delay="500">
                        <figure><img src="{{ asset('hotel_assets/img/blog-2.jpg') }}"  alt="" class="img-fluid"><em>21 Dec</em></figure>
                        <div class="wrapper">
