                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <h1 class="slide-animated two">{{ $room->number }}</h1>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-7 order-lg-1">
                    <div class="review_card">
                        <div class="row">
                            <div class="col-md-2 user_info">
                                <figure><img src="../../../../public/hotel_assets/img/avatar4.jpg" alt=""></figure>
                                <h5>Lukas</h5>
                            </div>
                    ...
                    <div class="review_card">
                        <div class="row">
                            <div class="col-md-2 user_info">
                                <figure><img src="../../../../public/hotel_assets/img/avatar6.jpg" alt=""></figure>
                                <h5>Lukas</h5>
                            </div>
                            <div class="col-md-10 review_content">
                                <div class="clearfix mb-3">
                    ...
                    <div class="review_card">
                        <div class="row">
                            <div class="col-md-2 user_info">
                                <figure><img src="../../../../public/hotel_assets/img/avatar1.jpg" alt=""></figure>
                                <h5>Marika</h5>
                            </div>
                            <div class="col-md-10 review_content">
                                <div class="clearfix mb-3">
                        ...
                        <div class="row reply">
                            <div class="col-md-2 user_info">
                                <figure><img src="../../../../public/hotel_assets/img/avatar.jpg" alt=""></figure>
                            </div>
                            <div class="col-md-10">
